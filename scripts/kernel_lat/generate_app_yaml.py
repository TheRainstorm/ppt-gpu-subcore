...
grid_sizes = [1, 2, 4, 8, 16, 32, 64, 96, 128, 160, 192, 224, 256, 512, 1024, 2048]
# block_sizes = [32, 64, 128, 256, 512, 1024]
# block_sizes = [128, 256, 512]
block_sizes = [1, 2, 4, 8, 16, 32, 64, 128, 256, 384, 512, 640, 768, 896, 1024]
...
with open('../apps/kernel_lat.yml', 'w') as f:
    yaml.dump(data, f)