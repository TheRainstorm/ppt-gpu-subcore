...
for app_and_arg in app_and_arg_list:
    ...
    if args.mpi_run != "":
        cmd = f"{args.mpi_run} python {args.ppt_src} {args.extra_params} --mpi --app {app_trace_dir} --sass --config {args.hw_config} {hw_res_option_str} --report-output-dir {args.report_output_dir} --kernel {kernel_ids} {no_overwrite_str}"
    else:
        cmd = f"python {args.ppt_src} {args.extra_params} --app {app_trace_dir} --sass --config {args.hw_config} {hw_res_option_str} --report-output-dir {args.report_output_dir} --kernel {kernel_ids} {no_overwrite_str}"
